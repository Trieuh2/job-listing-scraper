...
class IndeedSettingsFrame(ctk.CTkFrame):
    ...
    def __init__(self, master: ctk.CTk, font: ctk.CTkFont, values: Dict[str, str], validate_command: str):
        ...
        Args:
            ...
            validate_command (str): A command registered with the root widget using `register()`. This command is used to validate input in entry fields.
        """
